...
|--------------------------------------------------------------------------
| Phase 5 adds: payment gateway integration — citizen checkout
| initialization, server-side-verified callback, idempotent webhook,
| receipts, and payment history. A dev-only stub simulation endpoint
| mirrors the NIN stub pattern from Phase 2 so the full flow is
| testable without live gateway keys. Certificate generation remains
| schema-only until Phase 6.
*/
